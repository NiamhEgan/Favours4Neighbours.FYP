<html>
 ...
 <body>
  <div clas="container-fluid">
   <br />
   <h2 align="center"><a href="https://www.webslesson.info/2020/03/ajax-jquery-real-time-chat-application-using-codeigniter.html">Chat Application </a></h2>
   <br />
   ...
   <div class="col-md-6" style="padding-left:0; padding-right: 0;">
    <div class="panel panel-default" style="">
     ...
     <div class="panel-body">
      <div id="chat_header">
       <h2 align="center" style="margin:0; padding-bottom:16px;"><span id="dynamic_title">Welcome <?php  echo $username; ?></span></h2>
      </div>
...
$(document).ready(function(){
    ...
    success:function(data)
    {
     ...
     if(data.length > 0)
     {
      for(var count = 0; count < data.length; count++)
      {
       ...
       {
        output += '<div class="col-md-5"><button type="button" name="request_button" class="btn btn-warning btn-xs">Request Sent</button></div>';
       }
       else
       {
 ...
 setInterval(function(){
  if(recieverID > 0)
  {
   load_chat_data(recieverID, 'yes');
  }
  check_chat_notification(recieverID);
 }, 5000);

 function check_chat_notification(recieverID)
 {
