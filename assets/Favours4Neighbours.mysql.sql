...
CREATE TABLE `job` (
  ...
  KEY `fk_jobCounty_idx` (`JobCounty`),
  ...
  CONSTRAINT `fk_jobCategory` FOREIGN KEY (`JobCategory`) REFERENCES `jobcategory` (`Id`),
  CONSTRAINT `fk_jobCounty` FOREIGN KEY (`JobCounty`) REFERENCES `county` (`ID_county`)
) ENGINE=InnoDB AUTO_INCREMENT=123456854 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `job` VALUES (123457,123,124,'1 hour','No',200,15,'Shopping ',10,1,'2021-03-15 19:52:43','2021-03-15 19:52:43','2021-04-26 09:52:31'),(123456806,130,123,'4 hours','No',200,15,'Painitng ',30,1,'2021-04-03 06:57:25','2021-04-03 12:57:25','2021-04-03 06:57:25'),(123456834,NULL,123,'2 hours','none',206,14,'Farming help needed ',5,2,'2021-04-20 06:10:15','2021-04-20 12:10:15','2021-04-20 06:10:45'),(123456835,124,125,'2 hours','equipment provided',202,16,'Outdoor fence needs painting approx 10 meters ',20,2,'2021-04-20 06:30:52','2021-04-20 12:30:52','2021-04-20 06:36:27'),(123456837,123,126,'2 hours','Lawnmower',201,5,'   Gardening work neededmoving lawns ',30,1,'2021-04-21 03:25:14','2021-04-21 09:25:14','2021-05-01 09:58:28'),(123456838,NULL,126,'1 hour','car',207,1,'   shopping collected',15,2,'2021-04-21 03:37:16','2021-04-21 09:37:16','2021-05-01 07:07:46'),(123456839,NULL,127,'20 minutes','Car',207,18,'   Shopping Collection',7,2,'2021-04-26 15:59:13','2021-04-26 21:59:13','2021-04-26 15:59:13'),(123456840,NULL,124,'2 hours','Ladder',205,9,'   outdoor lighting needs changing ',0,2,'2021-04-27 10:49:23','2021-04-27 16:49:23','2021-04-27 10:49:23'),(123456841,136,128,'30 mins','car',207,18,'   collect shopping from tesco',5,1,'2021-04-28 07:57:38','2021-04-28 13:57:38','2021-04-28 07:57:38'),(123456842,NULL,128,'30 mins','Toolbox',200,16,'   Fix trek 4460',25,2,'2021-04-28 13:14:14','2021-04-28 19:14:14','2021-05-01 03:50:12'),(123456843,NULL,126,'30 minutes','Lead provided',210,8,'   Need very friendly  Elderly Golden Lab Walked ',15,2,'2021-05-01 10:14:43','2021-05-01 16:14:43','2021-05-01 10:14:43'),(123456844,NULL,126,'2 hours ','Please bring your own gloves',201,8,'   Need 3 5ft flowerbeds weeded at the front of the house',20,2,'2021-05-01 10:18:47','2021-05-01 16:18:47','2021-05-01 10:18:47'),(123456845,NULL,126,'4 hours','equipment provided',203,8,'   outdoor fence needs painting approx. 6 meters ',50,2,'2021-05-01 10:21:33','2021-05-01 16:21:33','2021-05-01 10:21:33'),(123456846,129,126,'1 hour','equipment provided ',200,8,'   need 2 bicycle chains replaced and put back on ',20,1,'2021-05-01 10:25:34','2021-05-01 16:25:34','2021-05-01 10:31:39'),(123456847,NULL,126,'5 hours ','Hedge Cutter',204,8,'   Hedge Cutting needed for large garen perimeter',75,2,'2021-05-01 10:29:46','2021-05-01 16:29:46','2021-05-01 10:29:46'),(123456848,128,136,'30 mins','Lightbulbs provided please bring your own Screwdrivers ',205,5,'Need 6 outdoor lights changed ',20,1,'2021-05-01 13:06:50','2021-05-01 19:06:50','2021-05-02 07:21:14'),(123456852,130,129,'1 hour','glue ',200,3,'tricycle needs fixing ',15,1,'2021-05-02 04:45:07','2021-05-02 10:45:07','2021-05-02 06:12:44'),(123456853,129,130,'2 hour','no',206,13,'Farming help needed',15,2,'2021-05-02 04:56:39','2021-05-02 10:56:39','2021-05-02 10:48:14');
...
CREATE TABLE `jobapplication` (
  ...
  KEY `fk_jobapplication_applicant_idx` (`Applicant`),
  CONSTRAINT `fk_jobapplication_applicant` FOREIGN KEY (`Applicant`) REFERENCES `user` (`Id`),
  CONSTRAINT `fk_jobapplication_job` FOREIGN KEY (`Job`) REFERENCES `job` (`Id`),
  CONSTRAINT `fk_jobapplication_status` FOREIGN KEY (`Status`) REFERENCES `jobapplicationstatus` (`Id`)
...
INSERT INTO `jobapplication` VALUES (58,123456838,129,'2021-05-02 11:39:55','2021-05-02 17:39:55','2021-05-02 11:39:55',2),(59,123456847,129,'2021-05-02 11:40:47','2021-05-02 17:40:47','2021-05-02 11:40:47',2),(60,123456845,129,'2021-05-02 11:40:52','2021-05-02 17:40:52','2021-05-02 11:40:52',2),(61,123456844,129,'2021-05-02 11:40:53','2021-05-02 17:40:53','2021-05-02 11:40:53',2),(62,123456847,130,'2021-05-02 11:41:51','2021-05-02 17:41:51','2021-05-02 11:41:51',2),(63,123456845,130,'2021-05-02 11:41:54','2021-05-02 17:41:54','2021-05-02 11:41:54',2),(64,123456844,130,'2021-05-02 11:41:54','2021-05-02 17:41:54','2021-05-02 11:41:54',2),(65,123456843,130,'2021-05-02 11:41:56','2021-05-02 17:41:56','2021-05-02 11:41:56',2),(66,123456838,130,'2021-05-02 11:42:00','2021-05-02 17:42:00','2021-05-02 11:42:00',2),(67,123456842,130,'2021-05-02 11:42:01','2021-05-02 17:42:01','2021-05-02 11:42:01',2);
...
CREATE TABLE `user` (
  ...
  KEY `fk_userCounty_idx` (`County`),
  CONSTRAINT `fk_userCounty` FOREIGN KEY (`County`) REFERENCES `county` (`ID_county`)
...
-- Dump completed on 2021-05-02 17:47:12
